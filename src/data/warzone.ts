...
export const warzoneImages = {
	...
	product: [
		{ src: '/img/sand-raiders-trampler.webp', alt: 'Sand raiders of sophie cheats ESP on a Trampler — Sand Raiders Cheats' },
		{ src: '/img/sand-raiders-combat.webp', alt: 'Sand Raiders Cheats wallhack ESP in combat on Windows PC' },
		{ src: '/img/sand-raiders-desert.webp', alt: 'Sand raiders aimbot across dunes — sandraiderscheats.net preview' },
		{ src: '/img/sand-raiders-storm.webp', alt: 'Sand raiders soft aim in a sandstorm — Sand Raiders of Sophie cheats' },
		{ src: '/img/sand-raiders-loot.webp', alt: 'Sand Raiders Cheats ESP and 2D loot radar on the map' },
		{ src: '/img/sand-raiders-extract.webp', alt: 'Sand raiders of sophie cheats during extract — Sand Raiders Cheats' },
	],
	gallery: [
		{ src: '/img/sand-raiders-extract.webp', alt: 'Sand raiders of sophie cheats during extract — sandraiderscheats.net', featured: true },
		...
		{ src: '/img/sand-raiders-desert.webp', alt: 'Sand raiders aimbot across dunes — Sand Raiders Cheats preview' },
