...
export const galleryUi: Record<LocaleCode, GalleryUi> = {
	en: {
		...
		lead:
			'Warzone Cheats is built for Call of Duty: Warzone\'s BR loop: read the map, track enemy squads, grab loot, and survive the gulag before the final circle closes in.',
		highlights: [
		...
		updatesLabel: 'Warzone cheat updates',
	...
	de: {
		...
		lead: 'Warzone Cheats passt zur BR-Schleife von Call of Duty: Warzone: Karte lesen, Gegner-Trupps tracken, looten und Reboot van überleben.',
		highlights: [
	...
	nl: {
		...
		lead: 'Warzone Cheats volgt de BR-loop van Call of Duty: Warzone: kaart lezen, vijandelijke squads volgen, looten en de gulag overleven.',
		highlights: [
	...
	ru: {
		...
		lead: 'Warzone Cheats создан для BR-цикла Call of Duty: Warzone: читать карту, отслеживать вражеские отряды, лут и выживать в gulag.',
		highlights: [
	...
	uk: {
		...
		lead: 'Warzone Cheats для BR-циклу Call of Duty: Warzone: читати карту, відстежувати ворожі загони, лут і виживати в gulag.',
		highlights: [
	...
	sv: {
		...
		lead: 'Warzone Cheats för Call of Duty: Warzone:s BR-loop: läs kartan, spåra fiendesquads, loota och överlev gulag.',
		highlights: [
