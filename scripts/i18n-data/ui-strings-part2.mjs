...
export const uiStringsPart2 = {
	ar: {
		...
		reviews: { title: 'ماذا يقول اللاعبون', subtitle: 'آراء حديثة من مشتري Warzone Hacks', outOf: 'من 5', countLabel: 'مراجعات' },
	...
	ja: {
		...
		reviews: { title: 'プレイヤーの声', subtitle: 'Warzone Hacks購入者からの最近のフィードバック', outOf: '/5', countLabel: '件のレビュー' },
	...
	ko: {
		...
		reviews: { title: '플레이어 후기', subtitle: 'Warzone Hacks 구매자 최근 피드백', outOf: '/5', countLabel: '리뷰' },
	...
	zh: {
		...
		reviews: { title: '玩家评价', subtitle: 'Warzone Hacks 买家近期反馈', outOf: '/5', countLabel: '条评价' },
	...
	hi: {
		...
		reviews: { title: 'खिलाड़ी क्या कहते हैं', subtitle: 'Warzone Hacks खरीदारों की हाल की प्रतिक्रिया', outOf: '/5', countLabel: 'समीक्षाएँ' },
	...
	id: {
		...
		reviews: { title: 'Apa kata pemain', subtitle: 'Umpan balik terbaru dari pembeli Warzone Hacks', outOf: 'dari 5', countLabel: 'ulasan' },
	...
	th: {
		...
		reviews: { title: 'ผู้เล่นพูดว่าอย่างไร', subtitle: 'ความคิดเห็นล่าสุดจากผู้ซื้อ Warzone Hacks', outOf: 'จาก 5', countLabel: 'รีวิว' },
	...
	vi: {
		...
		reviews: { title: 'Người chơi nói gì', subtitle: 'Phản hồi gần đây từ người mua Warzone Hacks', outOf: '/5', countLabel: 'đánh giá' },
	...
	uk: {
		...
		reviews: { title: 'Що кажуть гравці', subtitle: 'Останні відгуки покупців Warzone Hacks', outOf: 'з 5', countLabel: 'відгуків' },
	...
	cs: {
		...
		reviews: { title: 'Co říkají hráči', subtitle: 'Nedávná zpětná vazba od kupujících Warzone Hacks', outOf: 'z 5', countLabel: 'recenzí' },
	...
	ro: {
		...
		reviews: { title: 'Ce spun jucătorii', subtitle: 'Feedback recent de la cumpărătorii Warzone Hacks', outOf: 'din 5', countLabel: 'recenzii' },
	...
	sv: {
		...
		reviews: { title: 'Vad spelare säger', subtitle: 'Senaste feedback från Warzone Hacks-köpare', outOf: 'av 5', countLabel: 'recensioner' },
