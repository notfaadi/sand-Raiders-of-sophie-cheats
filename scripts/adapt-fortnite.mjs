#!/usr/bin/env node
/**
 * One-time migration: Sand Raiders Cheats template → Fortnite Cheats.
...
const RENAME_PAGE_DIRS = [
	['sand-raiders-aimbot', 'fortnite-aimbot'],
	['sand-raiders-esp', 'fortnite-esp'],
	['sand-raiders-wallhack', 'fortnite-wallhack'],
	['sand-raiders-radar-hack', 'fortnite-radar-hack'],
	['undetected-sand-raiders-cheats', 'undetected-fortnite-cheats'],
	['sand-raiders-cheats-2026', 'fortnite-cheats-2026'],
...
const REPLACEMENTS = [
	...
	['/products/sand-raiders', '/products/fortnite'],
	['sand-raiders-esp-wallhack', 'fortnite-esp-wallhack'],
	['sand-raiders-esp-hack', 'fortnite-esp'],
	['sand-raiders-aimbot-hack', 'fortnite-aimbot'],
	['undetected-sand-raiders-cheats', 'undetected-fortnite-cheats'],
	['sand-raiders-cheats-2026', 'fortnite-cheats-2026'],
	['sand-raiders-radar-hack', 'fortnite-radar-hack'],
	['sand-raiders-wallhack', 'fortnite-wallhack'],
	...
	['Call of Duty: Warzone', 'Fortnite'],
	['Call of Duty Warzone', 'Fortnite'],
	['Sand Raiders Cheats', 'Fortnite Cheats'],
	['Sand Raiders cheats', 'Fortnite cheats'],
	['Sand Raiders cheat', 'Fortnite cheat'],
	['Sand Raiders CheatsSite', 'FortniteCheatsSite'],
	['Sand Raiders CheatsSite', 'FortniteCheatsSite'],
	['Easy Anti-Cheat', 'Easy Anti-Cheat (EAC)'],
	['Easy Anti-Cheat maintenance', 'EAC maintenance'],
	['EAC bypass', 'EAC bypass'],
	['EAC Bypass', 'EAC Bypass'],
	['Easy Anti-Cheat', 'Easy Anti-Cheat (EAC)'],
	['eac-bypass', 'eac'],
	['the dunes, ruins, and extract points', 'Battle Royale island, Zero Build, and competitive lobbies'],
	['the dunes, ruins and extract points', 'Battle Royale island, Zero Build and competitive lobbies'],
